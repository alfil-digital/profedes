//docedes-plantillas/plantilla/modulos/administracion/personas/funciones.js
function editar(id) {
  $('html').animate({
    ...
    buttons: {
      'confirm': {
        ...
        action: function () {
          ...
          $.ajax({
            type: "POST",
            url: "modulos/administracion/personas/controlador.php?f=editar&id=" + id,
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
  ...
  $.confirm({
    ...
    buttons: {
      confirm: {
        ...
        btnClass: 'btn-green',
        action: function () {
          $.post("modulos/administracion/personas/controlador.php?f=eliminar",
            { id: id },
            function (dato) {
              $("#mensaje").css('display', 'block');
              $("#mensaje").html(dato);
