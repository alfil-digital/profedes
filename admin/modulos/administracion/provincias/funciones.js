function editar(id) {
  ...
  $.get("modulos/administracion/provincias/formulario.php?id=" + id, function (dato) {
...
function listado() {
  ...
  $.get("modulos/administracion/provincias/listado.php", function (dato) {
  ...
  $.confirm({
    ...
    buttons: {
      'confirm': {
        ...
        action: function () {
          // Acción para guardar
          $.post("modulos/administracion/provincias/controlador.php?f=editar", $("#form").serialize(), function (dato) {
  ...
  $.confirm({
    ...
    buttons: {
      confirm: {
        ...
        action: function () {
          // Acción de eliminar
          $.post("modulos/administracion/provincias/controlador.php?f=eliminar", { id: id }, function (dato) {
            $("#mensaje").css('display', 'block');
            $("#mensaje").html(dato);
            $('#mensaje').fadeIn('slow');
  ...
  $.confirm({
    ...
    buttons: {
      'confirm': {
        ...
        action: function () {
          //accion
          $.post("modulos/administracion/provincias/controlador.php?f=resetear_clave", { id: id }, function (dato) {
            $("#mensaje").html(dato);
            $('#mensaje').fadeIn('slow');
            listado();
            cerrar_formulario();
  ...
  $.confirm({
    ...
    buttons: {
      'confirm': {
        ...
        action: function () {
          //accion
          $.post("modulos/administracion/provincias/controlador.php?f=bloquear_usuario", { id: id }, function (dato) {
            $("#mensaje").html(dato);
            $('#mensaje').fadeIn('slow');
            listado();
            cerrar_formulario();
  ...
  $.confirm({
    ...
    buttons: {
      'confirm': {
        ...
        action: function () {
          //accion
          $.post("modulos/administracion/provincias/controlador.php?f=activar_usuario", { id: id }, function (dato) {
            $("#mensaje").html(dato);
            $('#mensaje').fadeIn('slow');
            listado();
            cerrar_formulario();
