function editar(id) {
  ...
  $.get("modulos/administracion/proveedores/formulario.php?id=" + id, function (dato) {
...
function listado() {
  ...
  $.get("modulos/administracion/proveedores/listado.php", function (dato) {
...
function validar_formulario() {
  ...
  if ($("#cuit").val().length < 3) {
    $("#cuit").focus();
    return 0;
  }
  if ($("#persona_id option:selected").text() === 'Seleccionar') {
    $("#persona_id").focus();
    return 0;
  }
    ...
    buttons: {
      'confirm': {
        ...
        action: function () {
          ...
          $.post("modulos/administracion/proveedores/controlador.php?f=editar", $("#form").serialize(), function (dato) {
  ...
  $.confirm({
    ...
    buttons: {
      confirm: {
        ...
        action: function () {
          //accion de eliminar
          $.post("modulos/administracion/proveedores/controlador.php?f=eliminar", { id: id }, function (dato) {
            $("#mensaje").css('display', 'block');
            $("#mensaje").html(dato);
            $('#mensaje').fadeIn('slow');
            listado();
